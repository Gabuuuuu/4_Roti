                ...
                <div class="card-body p-5 text-center">
                  <div class="mb-md-6 mt-md-4 pb-5">
                    <h2 class="fw-bold mb-4">
                      Introdu datele permisului de conducere al angajatului
                    </h2>

                    <p class="text-white-50 mb-4">
                      Completeaza toate campurile existente
                    </p>
                    <form
                    ...
                    >
                      <div class="form-outline form-white mb-4">
                        <p>
                          ...
                          <select
                            ...
                            @change="changeEmployeeText($event)"
                          >
                            <option
                      ...
                      <div class="form-outline form-white mb-4">
                        <h3>Nume:{{ form.nume_angajat }}</h3>
                        <h3>Prenume:{{ form.prenume_angajat }}</h3>
                        <h3>CNP:{{ form.CNP }}</h3>
                      </div>
                      <div class="form-outline form-white mb-4">
                        <p>
                          Introduceti locul nasterii angajatului
                          <input
                      ...
                      <div class="form-outline form-white mb-4">
                        <p>
                          Introduceti sediul care a emis permisul
                          <input
                      ...
                      <div class="form-outline form-white mb-4">
                        <p>
                          Introduceti numarul permisului
                          <input
...
export default {
  ...
  methods: {
      ...
      await axios
        ...
        .then(
          axios.spread((...responses) => {
            ...
            this.form.license_type = "B";
            this.form.nume_angajat = this.employees[0].nume_angajat;
            this.form.prenume_angajat = this.employees[0].prenume_angajat;
            this.form.CNP = this.employees[0].CNP;
          })
        )
        .catch((errors) => {
          console.log(errors);
    ...
    changeEmployeeText(event) {
      ...
      this.form.nume_angajat = this.activeEmploye.nume_angajat;
      this.form.prenume_angajat = this.activeEmploye.prenume_angajat;
      this.form.CNP = this.activeEmploye.CNP;
    },
  },
};
</script>
