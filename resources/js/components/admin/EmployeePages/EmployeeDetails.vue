              ...
              <div class="card bg-dark text-white" style="border-radius: 1rem">
                <div class="card-body p-5 text-center">
                  ...
                  <div class="mb-md-6 mt-md-4 pb-5">
                    ...
                    <p class="text-white-50 mb-4">Detaliile Angajatului</p>
                    ...
                    <div class="form-outline form-white mb-4">
                      <h4>
                        Apartamentul
                        {{ employee.apartament }}, sector {{ employee.sector }}
                      </h4>
                    </div>
                    <div class="form-outline form-white mb-4">
                      <h4>
                    ...
                    <div class="form-outline form-white mb-4">
                      ...
                      <h4>
                        <select
                          ...
                          class="
                            selectpicker
                            btn btn-outline-light btn-s
                            dropdown-toggle
                            form-control form-control-lg
                          "
                          data-style="btn-success"
                        >
                          <option v-for="role in roles" :key="role.index">
                            {{ role.denumire_rol }}
                          </option>
                        </select>
                      </h4>
    ...
    changeRole() {
      const payload = {
        role: this.roles.filter(
          (item) => item.denumire_rol === this.form.role
        )[0].role_id,
      };
