        ...
        <table class="table table-striped">
          <thead class="thead-dark table-dark">
            <tr>
              ...
              <th scope="col">
                <p class="text-center">Data Emiterii Permisului</p>
              </th>
              <th scope="col">
          ...
          <tbody>
            <tr v-for="license in licenses" :key="license.index">
              ...
              <td scope="row">
                <p class="text-center">
                  {{ formatDate(license.data_nasterii) }}
                </p>
              </td>
              <td scope="row">
                <p class="text-center">
              ...
              <td scope="row">
                <p class="text-center">
                  {{ formatDate(license.data_emiterii) }}
                </p>
              </td>
              <td scope="row">
                <p class="text-center">
                  {{ formatDate(license.data_expirarii) }}
                </p>
              </td>
              <td scope="row">
                <p class="text-center">
              ...
              <td scope="row">
                <p class="text-center">
                  {{ permisType[license.permis_suspendat] }}
                </p>
              </td>
            </tr>
          </tbody>
