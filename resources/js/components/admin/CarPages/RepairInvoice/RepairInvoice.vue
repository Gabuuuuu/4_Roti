            ...
            <div class="container">
                <div class="row">
                    ...
                    <p class="my-5 mx-5 text-center" style="font-size: 30px">
                        ...
                        masina {{ carDetails.marca }} {{ carDetails.model }}
                    </p>
                </div>
                ...
                <div class="row">
                    <ul class="list-unstyled">
                        <li class="text-black">
                            ...
                            {{ employeeDetails.prenume_angajat }}
                            {{ employeeDetails.nume_angajat }}
                        </li>
                        <br />
            ...
            await axios
                ...
                .then(
                    axios.spread((...responses) => {
                        ...
                        this.carDetails = responses[1].data[3].filter(
                            (item) => item.car_id === this.repairinvoice.car_id
                        )[0];
                        this.employeeDetails = responses[1].data[2].filter(
                            (item) =>
                                item.employee_id ===
                                this.repairinvoice.employee_id
                        )[0];
                    })
                )
                .catch((errors) => {
