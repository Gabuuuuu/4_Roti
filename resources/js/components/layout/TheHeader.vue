    ...
    <header id="header" class="d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            <li>
              <router-link class="nav-link" to="/home">Acasa </router-link>
            </li>
            <li>
              <router-link class="nav-link" to="/prices">Preturi </router-link>
            </li>
            <li>
              <router-link class="nav-link" to="/team">Echipa </router-link>
            </li>
            ...
            <li v-if="isAuthenticated && JSON.parse(this.retrieveRoleData)?.role_id >= 2">
